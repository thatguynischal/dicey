...
export default function Die(props){
    ...
    function images(a){
        if (a === 1 ){
            return(
                <TbDice1 className='dice-image'/>
            )
        } if (a ===2){
            return(
                <TbDice2 className='dice-image'/>
            )
        } if (a ===3){
            return(
                <TbDice3 className='dice-image'/>
            )
        }if (a ===4){
            return(
                <TbDice4 className='dice-image'/>
            )
        }if (a ===5){
            return(
                <TbDice5 className='dice-image'/>
            )
        }if (a ===6){
            return(
                <TbDice6 className='dice-image'/>
            )
        }   
    }
